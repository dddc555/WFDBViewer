...
*
* Copyright (C) 2015 - 2019 Teunis van Beelen
*
...
{
#ifdef Q_OS_LINUX
  QDesktopServices::openUrl(QUrl("file:///usr/share/doc/Cardio_Analyzer/manual.html#FMaudio_to_EDF"));
#endif
  ...
  strcat(p_path, "\\Cardio_Analyzer\\manual.html#FMaudio_to_EDF");
