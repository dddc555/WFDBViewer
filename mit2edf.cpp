...
UI_MIT2EDFwindow::UI_MIT2EDFwindow(char *recent_dir, char *save_dir, bool onlyShowFileOpenDialog, char *wfdb_path)
{
...
/////////////////// End conversion //////////////////////////////////////////
  ...
  strcpy(selectedWFDBHeaderFilePath, header_filename);
  isConverted = true;
