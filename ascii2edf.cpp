...
{
#ifdef Q_OS_LINUX
  QDesktopServices::openUrl(QUrl("file:///usr/share/doc/Cardio_Analyzer/manual.html#ASCII_to_EDF_converter"));
#endif
  ...
  strcat(p_path, "\\Cardio_Analyzer\\manual.html#ASCII_to_EDF_converter");
